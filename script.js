...
window.addEventListener('load', function() {
    setTimeout(function() {
        ...
        if (entries.length > 0) {
            ...
            trackEvent('page_load_time', { load_time_ms: Math.round(navEntry.loadEventEnd - navEntry.startTime), dom_content_loaded_ms: Math.round(navEntry.domContentLoadedEventEnd - navEntry.startTime), first_byte_ms: Math.round(navEntry.responseStart - navEntry.startTime), page: window.location.pathname });
        }
    }, 100);
});
